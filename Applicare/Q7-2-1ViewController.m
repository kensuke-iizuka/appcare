...
#import "Q7-2-1ViewController.h"

@interface Q7_2_1ViewController ()

@end

@implementation Q7_2_1ViewController
...
-(IBAction)nextView:(id)sender{
    if(self.selectedNum==1){
        [self performSegueWithIdentifier:@"q7-2-y" sender:self];
    } else if(self.selectedNum==2) {
        [self performSegueWithIdentifier:@"q7-2-n" sender:self];
    }
}
